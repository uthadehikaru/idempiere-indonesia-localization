...
/*REKA-0014 Delete .z-column-content*/
...
.z-grid-body .z-cell {
	padding: 1px 1px;  /*REKA-0014 */
	line-height: 22px; /*REKA-0014 */
}

.z-row .z-cell, .z-listitem .z-listcell, .z-listitem.z-listitem-selected>.z-listcell {
	border-left: 1px solid #cfcfcf;
	border-bottom: 1px solid #dddddd !important; /*REKA-0014 */
}
...
.info-panel .z-listbox-body{/*REKA*/
